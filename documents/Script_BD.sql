...
INSERT INTO spectacle (id, titre, description, url, horaire,duree, style) VALUES
...
INSERT INTO user (id, email, hash, role) VALUES
                                             (1, 'user1@example.com', 'hashed_password1', 1),
                                             (2, 'user2@example.com', 'hashed_password2', 1),
                                             (3, 'user3@example.com', 'hashed_password3', 1),
                                             (4, 'admin@example.com', 'hashed_admin_password', 100),
                                             (5, 'organizer@example.com', 'hashed_organizer_password', 2);
